                    ...
                    <table class="table">
                        ...
                        if(isset($_GET['from_date']) && isset($_GET['to_date']))
                        {
                            ...
                            $query = "SELECT ingreso.id_ingreso, ingreso.origen, ingreso.fechaIn, ingreso.horaIn, ingreso.id_carga, ingreso.matricula,
                                    ...
                                    LEFT JOIN transportista ON ingreso.id_transportista = transportista.id_transportista WHERE fechaIn BETWEEN '$from_date' AND '$to_date' ";
                        ...
                        foreach($query_run as $fila)
                        {
                            ...
                            <tr>
                                ...
                                <td><?php echo $fila['transportista->nombre'];?></td>
